...
import { WINBOAT_CACHE_HOME, WINBOAT_CONFIG_DIR, WINBOAT_DATA_DIR, WINBOAT_STATE_DIR } from "./constants";
import type {
    ComposeConfig,
    CustomAppCallbacks,
...
const USAGE_PATH = path.join(WINBOAT_CACHE_HOME, "appUsage.json");
...
export class Winboat {
    ...
    */
    async replaceCompose(composeConfig: ComposeConfig) {
        ...
        const backupDir = path.join(WINBOAT_CACHE_HOME, "backup");
    ...
    async resetWinboat() {
        ...
        fs.rmSync(WINBOAT_CACHE_HOME, { recursive: true, force: true });
        ...
        console.info(`Removed '${[WINBOAT_CACHE_HOME, WINBOAT_STATE_DIR, WINBOAT_CONFIG_DIR, WINBOAT_DATA_DIR]}'`);

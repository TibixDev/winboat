<template>
    <div class="flex flex-col gap-2 justify-center items-center mt-12">
        <div :key="currentStepIdx" id="stepIcon" class="flex items-center justify-center relative size-[30rem]">
        ...
        <p class="text-gray-400 max-w-[40vw] text-center">
            Please wait while we migrate your existing WinBoat configuration to
